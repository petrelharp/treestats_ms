...
and so summaries of popluation genetic data usually begin with this data structure.
However, since the genetic variation represented in a genotype matrix
was generated by mutations inherited down genealogical trees,
...
and the frequencies of all of them can be easily found by propagating sample counts up the tree.
...
and allow us to compute with genetic data far more efficiently than with the genotype data itself.
