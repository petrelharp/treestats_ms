...
We exploit this duality here to create a method that efficiently computes single-site statistics
...
bespoke matrix-based methods in terms of both run time and memory requirements.
...
and discuss ways in which deviations may hold interesting biological
signals.

\jk{Not sure if the last bit is expressed the right way}
...
remove any edges that were in the previous and tree are not in the
...
\citep[see, e.g.,][]{martin2017human,galloway2019stickleback}.
...
This additional mode of reporting statistics, however, is postponed for future work.
...
such as linkage disequilibrium are planned for future work.
