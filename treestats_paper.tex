...
\begin{figure}
    ...
    \caption{
        ...
        and \textbf{(bottom)}
        the dual branch statistic as calculated from tree sequences inferred by Relate~\citep{speidel2019method},
        in units of generations \plr{XXX confirm this}.
...
\begin{figure}[!h]
    \includegraphics{{figures/intro/introgressed.1000.23.1000000.1e-09.f4}.pdf}
    \caption{
