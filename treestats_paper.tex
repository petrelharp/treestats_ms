...
Genotype matrices are massively redundant, however, and several compression methods
have been proposed~\citep{durbin2014efficient} \jk{TODO more refs}.
...
\begin{example}[Patterson's $f_4$] \label{ex:site_f4}
    ...
    is $(p_1 - p_2)(p_3 - p_4)$ \jk{CITATION NEEDED}.
