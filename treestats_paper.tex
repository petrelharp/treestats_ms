...
This would be similar to imputation, and would likely face similar challenges.

% visualization and time decomposition adding a new dimension
\krt{this para needs to go, right, now that the related results are offloaded
into a new tex file? Perhaps say that we can do this sort of thing?}
