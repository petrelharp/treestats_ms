...
A key area of inefficiency in existing methods is that they focus on representing
the genotype data as a \emph{matrix}.  As such, computational complexity if often linear
in the matrix size. An alternative would be to take advantage of the relatedness amongst
individuals in the sample and represent the data as trees.
Trees describe the ancestral relationships between
samples~\citep{felsenstein2004inferring,semple2003phylogenetics},
and provide a natural and elegant way of encode genetic data,
...
mcvean2002genealogical,ralph2019empirical}. We build on this central
