...
%%%%%%%%%%%%%%%%%%
\subsection*{Empirical duality between branch and site statistics?}
...
in windows of 500Kb \plr{check this}
separately in each of its 26 populations,
...
These are shown in Figure~\ref{fig:chr20}.

\begin{figure}
    \includegraphics[width=0.5\textwidth]{{figures/1kg/relate_site_diversity_chr20}.png}
    \includegraphics[width=0.5\textwidth]{{figures/1kg/tsinfer_1kg_chr20.branch_diversity.2000000}.pdf}
    \includegraphics[width=0.5\textwidth]{{figures/1kg/tgp_geva_chr20.branch_diversity.2000000}.pdf}
    \includegraphics[width=0.5\textwidth]{{figures/1kg/relate_branch_diversity_chr20}.png}
    \caption{
        \textbf{(A)} Mean sequence diversity 
        in 500Kb \plr{?} windows along human chromosome 20 of the 1000 Genomes Project,
...
These are different because of XXX but similar YYY.
As discussed above, we expect site and branch statistics to agree up to noise
if mutation rates are constant along the genome.
However, this caveat may well be substantial -- mutation rates are likely \emph{not} constant
\citep{mut_rate_variation},
