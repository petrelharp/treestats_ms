...
and computational complexity is often linear in the size of the matrix. 
...
an alternative would be to take advantage of the relatedness amongst
individuals and represent the data using trees.
...
would be to use a polarized Site statistic with summary function $f(x) = 2 x(n-x)/n(n-1)$.
